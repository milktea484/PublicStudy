...
for k in range(max_k):
    ...
    out_path = f"results/{current_timestamp}/{dataset}_kfold/{llm}/{k}"
    weight_path = f"results/{current_timestamp}/{dataset}_kfold/{llm}/{k}/weights"
    ...
    print(f"ArchiveII FOLD {k} TESTING ENDED".center(80))
