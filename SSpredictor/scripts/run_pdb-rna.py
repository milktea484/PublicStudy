...
print("+" * 80)
print(f"PDB-RNA TRAINING STARTED".center(80))
print("+" * 80)
...
print(f"PDB-RNA TRAINING ENDED".center(80))
print("+" * 80)
print(f"PDB-RNA TESTING STARTED".center(80))
print("+" * 80)
...
print(f"PDB-RNA TESTING ENDED".center(80))
